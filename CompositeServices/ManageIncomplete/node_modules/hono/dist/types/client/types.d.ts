...
import type { METHODS, METHOD_NAME_ALL_LOWERCASE } from 'hono/router';
import type { Endpoint, ExtractSchema, KnownResponseFormat, ResponseFormat, Schema } from 'hono/types';
